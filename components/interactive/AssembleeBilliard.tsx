...
import { facetResult, type FacetKind } from "@/lib/data/assembleeInsights";
...
type Pocket = { x: number; y: number; kind: FacetKind; label: string };
...
type Popup = { row: AssembleeRow; kind: FacetKind };
