    ...
    <div className="sol-body">
      ...
      <div className="sol-stat">
        ...
        <div className="rel-strip" aria-hidden>
          ...
          <span
            className="lbl m"
            title="Échelle relative provisoire : « plus divergent », « habituel » ou « plus convergent » que la normale. Le centre marque un bloc médian ; cette calibration sera affinée. La divergence reste la règle, même à un niveau habituel."
          >
            habituel
          </span>
