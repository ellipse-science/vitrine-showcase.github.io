...
#sources .kick{position:absolute;top:282px;left:180px;font-size:28px;color:var(--soft)}
#sources h2{position:absolute;top:330px;left:180px;right:180px;font-size:76px;line-height:1.02}
...
.scene .tete{position:absolute;top:336px;left:180px;right:180px}
...
.scene .ech{position:absolute;left:180px;top:700px;width:900px;height:410px;transform:scale(.8);transform-origin:0 0}
.scene .site{position:absolute;left:180px;right:180px;top:1216px;font-size:38px;line-height:1.2}
...
#recap li{display:flex;align-items:center;gap:26px;height:100px;text-align:left;padding:0 26px;border-left:14px solid}
