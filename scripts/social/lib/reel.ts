 ...
 *    · haut 300 px   : nom du compte, titre de la musique, et la caméra ou
 *      l'îlot dynamique des iPhone récents ;
 ...
 *  dans les guides 2026 (SocialSizes, Wavegen, Outfy). Le haut est passé de 250 à
 *  300 px le même jour (Jules Piral : « ce qui est en haut on va le perdre à cause
 *  de la caméra sur iPhone »). */
export const SAFE = { top: 300, bottom: HEIGHT - 450, left: 60, right: WIDTH - 60, buttonsTop: 640, buttonsLeft: WIDTH - 120 };
...
#intro .logo{position:absolute;top:312px;left:76px;width:540px}
#intro .module{position:absolute;top:512px;left:76px;right:76px;display:flex;align-items:center;gap:20px;font-size:28px;color:var(--soft)}
#intro .module i{display:block;width:120px;height:10px;transform-origin:left}
#intro h1{position:absolute;top:585px;left:76px;right:120px;font-size:132px;line-height:1.02;font-family:"Playfair Display",serif;font-weight:900;letter-spacing:-.02em}
...
#fin{display:flex;flex-direction:column;align-items:center;text-align:center;padding:316px 120px 0 76px}
