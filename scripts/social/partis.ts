...
.head{position:absolute;top:186px;left:116px;right:180px}
...
#accroche .brand{position:absolute;top:190px;left:116px;right:180px;display:flex;align-items:center;gap:20px;font-size:30px;color:var(--soft)}
...
/* Le jour, en vumètre */
#jour .chart{position:absolute;top:470px;left:116px;right:180px;height:840px;display:flex;gap:28px}
...
/* Par média */
#playlist .rows{position:absolute;top:452px;left:116px;right:180px}
#playlist .row{height:142px;padding-top:12px;border-top:2px solid var(--rule)}
...
/* Ton */
#ton .legend{position:absolute;top:470px;left:116px;right:180px;display:flex;justify-content:space-between;font-size:28px;letter-spacing:.06em}
#ton .rows{position:absolute;top:522px;left:116px;right:180px}
#ton .row{height:156px;display:flex;align-items:center;gap:28px;border-top:2px solid var(--rule)}
#ton .needle{width:260px;height:146px;flex:none}
#ton .lab{font-family:"Playfair Display",serif;font-weight:900;font-size:46px}

/* Campagne */
#campagne .rows{position:absolute;top:500px;left:116px;right:180px}
#campagne .row{height:158px;display:flex;align-items:center;gap:24px;border-top:2px solid var(--rule)}
