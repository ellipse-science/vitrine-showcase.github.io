...
/* Le jour, en vumètre */
#jour .chart{position:absolute;top:560px;left:76px;right:120px;height:750px;display:flex;gap:28px}
...
/* Par média */
#playlist .rows{position:absolute;top:548px;left:76px;right:120px}
#playlist .row{height:130px;padding-top:12px;border-top:2px solid var(--rule)}
...
/* Ton */
#ton .legend{position:absolute;top:576px;left:76px;right:120px;display:flex;justify-content:space-between;font-size:28px;letter-spacing:.06em}
#ton .rows{position:absolute;top:628px;left:76px;right:120px}
#ton .row{height:140px;display:flex;align-items:center;gap:28px;border-top:2px solid var(--rule)}
#ton .needle{width:260px;height:146px;flex:none}
#ton .lab{font-family:"Playfair Display",serif;font-weight:900;font-size:46px}

/* Campagne */
#campagne .rows{position:absolute;top:608px;left:76px;right:120px}
#campagne .row{height:142px;display:flex;align-items:center;gap:24px;border-top:2px solid var(--rule)}
