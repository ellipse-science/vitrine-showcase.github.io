...
#intro .mini-ranks{position:absolute;left:180px;right:180px;bottom:${RESERVE_BAS}px;height:430px}
...
#course .board{position:absolute;left:180px;right:180px;top:570px;bottom:${RESERVE_BAS + 60}px}
...
#course .note{position:absolute;left:180px;right:180px;bottom:${RESERVE_BAS}px;font-size:30px;line-height:1.2;color:var(--soft);font-style:italic}
...
#bilan .body{position:absolute;left:180px;right:180px;top:492px;bottom:${RESERVE_BAS + 60}px}
...
#bilan .note{position:absolute;left:180px;right:180px;bottom:${RESERVE_BAS}px;font-size:30px;line-height:1.2;color:var(--soft);font-style:italic}
`;
